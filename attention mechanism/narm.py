...
class NARM(nn.Module):
    ...
    def __init__(self, n_items, hidden_size, embedding_dim, batch_size, n_layers = 1):
        ...
        self.b = nn.Linear(self.embedding_dim, 2 * self.hidden_size, bias=False)  ##on
        #self.b = nn.Linear(self.embedding_dim, self.hidden_size, bias=False) ##off
        #self.sf = nn.Softmax()
